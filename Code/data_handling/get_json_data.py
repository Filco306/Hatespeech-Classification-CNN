...
innocent_tweets = get_tweets(2, "data/share/neither.json")
hate_speech_tweets = get_tweets(0, "data/share/racism.json")
print("Number of racist tweets ")
print(len(hate_speech_tweets))
hate_speech_tweets_2 = get_tweets(0, "data/share/sexism.json")
...
data.to_csv("data/tweets_third_dataset.csv", sep='\t', encoding='utf-8')
